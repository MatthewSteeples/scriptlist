/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 23cac082171cb6467cb34773168dd042)
// Runtime types generated with workerd@1.20260515.1 2026-01-01 
interface __BaseEnv_Env {
	CSV_BUCKET: R2Bucket;
	DB: D1Database;
	VALUE_FROM_CLOUDFLARE: "Hello from Hono/CF";
	IMPORT_ORCHESTRATOR: DurableObjectNamespace<import("./workers/app").EnglandImportDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "EnglandImportDurableObject";
	}
